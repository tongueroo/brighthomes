...
<div id="header">
    ...
    <div id="navcontainer">
   	  <div id="nav-wrap">
            ...
            <li<?php if ($thisSecPage=="about") 
      echo " class=\"current_page_item\""; ?>><a rel="#8d5917" href="secondary/about.php">About</a></li>
            <li<?php if ($thisSecPage=="services") 
      echo " class=\"current_page_item\""; ?>><a rel="#274967" href="secondary/services.php">Services</a></li>
            <li <?php if ($thisSecPage=="ourwork") 
      echo " class=\"current_page_item\""; ?>><a rel="#ab4c20" href="secondary/ourwork.php">Our Work</a></li>
            <li <?php if ($thisSecPage=="news") 
      echo " class=\"current_page_item\""; ?>><a rel="#593e29" href="secondary/work.php">News</a></li>
       	  </ul>
      </div>
