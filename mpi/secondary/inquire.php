      ...
      <div id="container">
      		...
      		<div id="content">
            	<div id="leftcontent">
            	  ...
            	  <p>
Call us at 1-800-515-1156 or 925-735-9718 to request a copy, or use the form below.</p>
...
<form name="request" method="post" action="brochure_actions.php" onSubmit="return validateForm(this);">
			  ...
			  <table width="100%" border="0" cellspacing="6" cellpadding="3">
                <tr bgcolor="#C3AC99"> 
                  <td height="20" colspan=2 class="formtopic">
				  	<table width="100%" cellspacing="0" cellpadding="0">
						<tr>
							
                        <td class="formtopic">Mail Brochure and CD To:</td>
							<td><div align="right" style="font-size: 7pt; color: #663818;">(all fields required)</div></td>
						</tr>
					</table>				  
				  </td>
				</tr>
				...
				<table width="100%" border="0" cellspacing="6" cellpadding="3">
                <tr bgcolor="#C3AC99">
                  <td height="20" colspan="3" class="formtopic">Design Interest:</td>
                </tr>
                <tr>
